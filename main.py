...
def send_to_whisper_api(filepath):
    ...
    client.api_key = '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'  
...
# Read the data into the dataframe from an Excel file
df = pd.read_excel('details.xlsx', sheet_name='Blad1')
